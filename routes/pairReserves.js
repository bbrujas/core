...
const getPairReserves = express.Router();

getPairReserves.get("/:pair", async (req, res) => {
    ...
    try {
        //const result = ;
        res.payload = (await contract.getReserves()).toString();
    }
    catch (error) {
        log.error(error);
...
module.exports = getPairReserves

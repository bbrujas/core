...
const getPairPrice0CumulativeLast = express.Router();

getPairPrice0CumulativeLast.get("/:pair", async (req, res) => {
    ...
    try {
        //const result = ;
        res.payload = (await contract.price0CumulativeLast()).toString();
    }
    catch (error) {
        log.error(error);
...
module.exports = getPairPrice0CumulativeLast

...
const getPairTotalSupply = express.Router();

getPairTotalSupply.get("/:pair", async (req, res) => {
    ...
    try {
        //const result = ;
        res.payload = (await contract.totalSupply()).toString();
    }
    catch (error) {
        log.error(error);
...
module.exports = getPairTotalSupply

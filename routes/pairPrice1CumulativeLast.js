...
const getPairPrice1CumulativeLast = express.Router();

getPairPrice1CumulativeLast.get("/:pair", async (req, res) => {
    ...
    try {
        //const result = ;
        res.payload = (await contract.price1CumulativeLast()).toString();
    }
    catch (error) {
        log.error(error);
...
module.exports = getPairPrice1CumulativeLast
